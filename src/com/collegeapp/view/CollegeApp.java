...
public class CollegeApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTblStudentTitle.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        btnRemove.setBackground(new java.awt.Color(234, 192, 32));
                ...
                .addGroup(pnlStudentListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlStudentListLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlStudentListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtID)
                            .addComponent(txtProgram, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(141, 141, 141)
                        .addGroup(pnlStudentListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        pnlMainScreenLayout.setVerticalGroup(
            ...
            .addGroup(pnlMainScreenLayout.createSequentialGroup()
                ...
                .addComponent(tabPaneMain, javax.swing.GroupLayout.DEFAULT_SIZE, 618, Short.MAX_VALUE))
        );
        ...
        pnlLoginScreenLayout.setVerticalGroup(
            ...
            .addGroup(pnlLoginScreenLayout.createSequentialGroup()
                ...
                .addGap(37, 264, Short.MAX_VALUE))
            .addComponent(pnlLoginLeft, javax.swing.GroupLayout.DEFAULT_SIZE, 659, Short.MAX_VALUE)
        );

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setMinimumSize(new java.awt.Dimension(1130, 614));
...
// Method to set up the CardLayout and add panels
    ...
    if (!id.matches("\\d+")) {
        JOptionPane.showMessageDialog(this, "ID should be a number");
        return false;
    }
    ...
    if (!contact.matches("\\d{10}")) {
        JOptionPane.showMessageDialog(this, "Contact should be a 10-digit number");
        return false;
    }
    ...
    try {
        ...
        if (age < 0 || age > 100) { // Assuming a reasonable age range
            JOptionPane.showMessageDialog(this, "Enter a valid Age (0-100)");
            return false;
        }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (validateFields()) {
            ...
            String contact = txtContact.getText().trim();
            short age = Short.parseShort(txtAge.getText().trim());

            StudentModel newStudent = new StudentModel(id, name, program, contact, age);
            registerStudent(newStudent); // Add the student to the list and table
    ...
    if (selectedRow >= 0) {
        // Get the LMU ID of the selected student to remove from the list
